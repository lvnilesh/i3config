...
sudo pacman -S --needed --noconfirm gdm gnome gnome-extra base xorg-server i3-wm i3status feh playerctl pulseaudio ttf-jetbrains-mono nvidia nvidia-utils vi openssh bluez git wezterm -y
